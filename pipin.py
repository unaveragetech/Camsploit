...
"""
"""
setup= just put this file in the same dir and put the following 2 lines first in your script 
make sure you have a 'requirements.txt' in the same dir after adding the 2 lines just run your script 
